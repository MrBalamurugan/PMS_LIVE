              ...
              sx={{
                boxShadow:
                  theme.palette.mode === ThemeMode.DARK
                    ...
                    : `0px 1px 4px ${alpha(theme.palette.grey[900], 0.08)}`, //X-zero
                minWidth: 750,
                width: {
                  md: `calc(100vw - 100px)`,
                ...
                <MainCard elevation={0} border={false} content={false}>
                  <Grid container>
                    <Grid
                      ...
                      md={4}
                      sx={{
                        background: `url(${backgroundVector}), linear-gradient(183.77deg, ${theme.palette.primary.main} 11.46%, ${theme.palette.primary.dark} 100.33%)`, //x-zero
                      }}
                    >
                      <Box sx={{ p: 4.5, pb: 3 }}>
