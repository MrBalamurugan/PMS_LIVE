...
const FooterBlock = ({ isFull }: any) => {
  ...
  return (
    <>
      ...
      <Box
        sx={{ pt: isFull ? 0 : 10, pb: 10, bgcolor: theme.palette.grey.A700 }}
      >
        <Container>
              ...
              <Grid container spacing={{ xs: 5, md: 2 }}>
                <Grid item xs={6} sm={3}>
                  <Stack spacing={{ xs: 3, md: 5 }}>
                    ...
                    <Stack spacing={{ xs: 1.5, md: 2.5 }}>
                      <FooterLink
                        href="https://links.codedthemes.com/nOuhw"
                        target="_blank"
                        underline="none"
                      >
                        Blog
                      ...
                      <FooterLink
                        href="https://links.codedthemes.com/BQFrl"
                        target="_blank"
                        underline="none"
                      >
                        Documentation
                      ...
                      <FooterLink
                        href="https://links.codedthemes.com/rhzvh"
                        target="_blank"
                        underline="none"
                      >
                        Change Log
                ...
                <Grid item xs={6} sm={3}>
                  <Stack spacing={{ xs: 3, md: 5 }}>
                    ...
                    <Stack spacing={{ xs: 1.5, md: 2.5 }}>
                      <FooterLink
                        href="https://links.codedthemes.com/zyACc"
                        target="_blank"
                        underline="none"
                      >
                      ...
                      <FooterLink
                        href="https://links.codedthemes.com/WztNI"
                        target="_blank"
                        underline="none"
                      >
                        Free Berry React
